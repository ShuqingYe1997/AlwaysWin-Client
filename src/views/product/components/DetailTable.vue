    ...
    <table>
      ...
      <tbody>
          ...
          <tr v-if="!readMoreInfo"  >
            <td colspan="2" style="text-align: center;box-shadow: 0 0 10px rgba(0,0,0,0.1);line-height:12px" >
              <a @click="activateMoreInfo" class="readmore">
              READ MORE
              </a>
            </td>
          </tr>
      ...
      <tbody>
        ...
        <tr>
            <td v-if="!readMoreDesc" style="width:100%">{{productInfo.description.slice(0, 200)}}</td>
            <td v-if="readMoreDesc" style="width:100%"> {{productInfo.description}}</td>
       </tr>
       <tr v-if="!readMoreDesc && productInfo.description.length > 199"  >
        <td colspan="2" style="text-align: center;box-shadow: 0 0 10px rgba(0,0,0,0.1);line-height:12px" >
          <a @click="activateMoreDesc" class="readmore">
          READ MORE
          </a>
        </td>
      </tr>
