        ...
        <div class="col-md-7 col-sm-7 col-xs-12">
          ...
          <div class="pl-6">
            ...
            <v-card-actions class="pa-0">
              <p class="headline font-weight-light pt-3">${{ productForm.productStatus.price }}</p>
              <v-spacer />
            </v-card-actions>
            <p v-if="productForm.description.length < 400" class="subtitle-1 font-weight-thin">
            ...
            <div
              v-if="productForm.productStatus.status === 'bidding' || productForm.productStatus.status.includes('extended')"
              class="end-item"
            >
              <p class="title">Time before ending</p>
              <Countdown :deadline="productForm.productStatus.endTime | formatDate1" />
            </div>
            <div
            ...
            >
              ...
              <Countdown :deadline="productForm.productStatus.startTime | formatDate1" />
            </div>
            <div
              v-else-if="productForm.productStatus.status === 'success' || productForm.productStatus.status === 'broughtIn'"
              class="warning-item"
            >
              Auction has finished!
            </div>
            <div v-else-if="productForm.productStatus.status === 'canceled'" class="warning-item">
            ...
            <v-btn class="primary white--text" outlined tile dense :disabled="productForm.productStatus.status !== 'bidding'">Place Offer</v-btn>
  ...
  methods: {
    ...
    fetchData(passed_pid) {
      productDetail(passed_pid).then(response => {
        ...
        this.user_offer = this.productForm.productStatus.price + this.productForm.minIncrement
    ...
    ProcessData(passed_pid) {
      ...
      if (productStatuOption[this.productForm.status] <= productStatuOption['waiting']) {
      ...
      } else if (productStatuOption[this.productForm.status] <= productStatuOption['broughtIn']) {
...
div.v-window__next{background:rgba(0,0,0,.3);border-radius:50%;position:absolute;margin:0 16px;left:100% !important;top:calc(50% - 100px) !important;z-index:1}
.display-1, .display-2{font-weight:400;font-family:Roboto,sans-serif!important} .display-1{font-size:2.125rem!important;line-height:2.5rem;letter-spacing:.0073529412em!important}
.mb-0{margin-bottom:0!important}
.pb-0{padding-bottom:0!important}
.headline{font-size:1.5rem!important;font-weight:400;letter-spacing:normal!important} .headline, .title{padding: 12px 0px 0px !important; line-height:2rem;font-family:Roboto,sans-serif!important} .title{font-size:1.25rem!important;font-weight:500;letter-spacing:.0125em!important}
.font-weight-light{font-weight:300!important}
.pt-10{padding-top:40px!important}.pl-6{padding-left:24px!important} .pa-0{padding:0!important}.pt-3{padding-top:12px!important}
.subtitle-1{font-size:1rem!important;font-weight:400;letter-spacing:.009375em!important;line-height:1.75rem;font-family:Roboto,sans-serif!important}.font-weight-thin{font-weight:100!important}
</style>
