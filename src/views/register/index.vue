<template>
  <div class="regis-container">
    <el-form ref="regisForm" :model="regisForm" :rules="loginRules" class="regis-form" autocomplete="on" label-position="left">

      <div class="title-container">
        <h3 class="title">Create AlwaysWin Account</h3>
      </div>
...
export default {
  ...
  mounted() {
    ...
    } else if (this.regisForm.password === '') {
...
@supports (-webkit-mask: none) and (not (cater-color: $cursor)) {
  .regis-container .el-input input {
    color: $cursor;
  }
}
